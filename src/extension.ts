...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		...
		vscode.commands.registerCommand('claude-code-chat.openChat1', () => providers[0].show(vscode.ViewColumn.One)),
		vscode.commands.registerCommand('claude-code-chat.openChat2', () => providers[1].show(vscode.ViewColumn.Two)),
		vscode.commands.registerCommand('claude-code-chat.openChat3', () => providers[2].show(vscode.ViewColumn.Three)),
		vscode.commands.registerCommand('claude-code-chat.loadConversation', (f: string) => providers[0].loadConversation(f)),
	...
	private createMessageCallbacks() {
		return {
			...
			onOpenConversationInNewPanel: async (f: string) => {
				...
				await vscode.commands.executeCommand('claude-code-chat.loadConversation', f);
			}
		};
	}
